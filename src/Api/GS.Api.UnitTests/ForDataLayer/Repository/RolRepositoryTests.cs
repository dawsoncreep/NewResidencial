// --------------------------------------------------------------------------------------------------------------------
// <copyright file="RolRepositoryTests.cs" company="Dawsoncreep GitHub Repository(https://github.com/dawsoncreep/).">
//   COPYRIGHT 2020 © Dawsoncreep. All rights reserved.
// </copyright>
// <summary>
//   Defines the RolRepositoryTests type.
// </summary>
// --------------------------------------------------------------------------------------------------------------------
...
namespace Authentication.UnitTests.ForDataLayer.Repository
{
    ...
    public class RolRepositoryTests
    {
        ...
        /// <summary>
        /// The user rol test data.
        /// </summary>
        private List<SUserRol> userRolTestData;

        /// <summary>
        /// The rol permissions test data.
        /// </summary>
        private List<SRolPermission> rolPermissionsTestData;
        ...
        public async Task RunBeforeEachTest()
        {
            ...
            this.userRolTestData = JsonConvert.DeserializeObject<List<SUserRol>>("[{\"IdUsuario\":\"1\",\"IdRol\":\"1\",\"Activo\":\"True\"}]");
            this.rolPermissionsTestData = JsonConvert.DeserializeObject<List<SRolPermission>>("[{\"IdRol\":\"1\",\"IdPermiso\":\"1\",\"Activo\":\"True\"},{\"IdRol\":\"1\",\"IdPermiso\":\"2\",\"Activo\":\"False\"},{\"IdRol\":\"1\",\"IdPermiso\":\"3\",\"Activo\":\"True\"}]");
        ...
        public async Task GetAuthorizationDataShouldSucceed()
        {
            // Arrange
            const int UserId = 1;
            var objectUt = new RolRepository(this.applicationContext);
