...
namespace Authentication.UnitTests.ForBusinessLayer.Facades
{
    ...
    using GS.Api.BusinessLayer.Facade;
    ...
    public class UserFacadeTests
    {
        ...
        public async Task AuthenticateShouldValidateUserCredentials()
        {
            // Arrange 
            //  Valid user sample
            this.userUnderTest = new User { Id = 1, Name = this.loginRequest.UserName, Password = this.loginRequest.Password };
        ...
        public async Task AuthenticateShouldFailValidatingUserAccess()
        {
            // Arrange 
            //  Bad user sample
            this.userUnderTest = new User { Id = 1, Name = this.loginRequest.UserName, Password = "DifferentPassword" };
