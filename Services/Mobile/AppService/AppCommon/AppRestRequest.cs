...
namespace AppService.AppCommon
{
    ...
    public static class AppRestRequest
    {
       ...
       private const String RESOURCE_SERVICE_URL = "http://guizzy.dyndns.org/SecureGateAPI/";
        private const String AUTH_SERVICE_URL = "http://guizzy.dyndns.org/AuthServer/";
        private const String AUDIENCE_ID = "18fc7e3e20854a7584f7eea70063e5b7";
